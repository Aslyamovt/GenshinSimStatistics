...
TRANSLATIONS = {
    "ru": {
        ...
        "wf_btn_invalid": "Сделать невалидным",
        ...
        "wf_invalidated": "Замер помечен как невалидный.",
        "wf_prev": "◀ Назад",
        "wf_next": "Вперёд ▶",
    ...
    "en": {
        ...
        "wf_btn_invalid": "Mark as invalid",
        ...
        "wf_invalidated": "Measurement marked as invalid.",
        "wf_prev": "◀ Back",
        "wf_next": "Forward ▶",
