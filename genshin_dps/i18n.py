...
TRANSLATIONS = {
    "ru": {
        ...
        "src_filter_label": "Источник",
        "src_gcsim": "Только gcsim",
        "src_wf_unique": "Wfpsim для уникальных",
        "src_wf_all": "Wfpsim для всех",
        "wf_make_invalid": "Сделать невалидной",
    ...
    "en": {
        ...
        "src_filter_label": "Source",
        "src_gcsim": "Only gcsim",
        "src_wf_unique": "Wfpsim for unique",
        "src_wf_all": "Wfpsim for all",
        "wf_make_invalid": "Mark as invalid",
